...
<header class="topbar">
  ...
  <nav class="topbar__nav">
    <a class="navlink <?= $activePage === 'inicio' ? 'is-active' : '' ?>" href="index.php">Início</a>
    <a class="navlink <?= $activePage === 'clientes' ? 'is-active' : '' ?>" href="clientes.php">Clientes</a>
    <a class="navlink <?= $activePage === 'emprestimos' ? 'is-active' : '' ?>" href="emprestimos.php">Empréstimos</a>
    <a class="navlink <?= $activePage === 'vencimentos' ? 'is-active' : '' ?>" href="vencimentos.php">Vencimentos</a>
  </nav>
